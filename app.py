...
# # Option to switch between URL and Image upload
# mode = st.radio("Choose input method:", ("URL", "Image Upload"))
...
#         if not all_pages:
#             page_numbers = st.text_input("Enter page numbers separated by commas (e.g., 0,1,2 for first three pages):")
#             if page_numbers:
#                 pages = [int(num) for num in page_numbers.split(",")]
#             else:
#                 pages = None
#         else:
#             pages = None
