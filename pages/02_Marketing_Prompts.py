...
prompt_options = {
    "Summarize": "Read the content above slowly and take your time to understand it. Think through carefully step by step. Extract the key insights and takeaways a few paragraphs at a time instead of looking at everything. Write in point form and organize section in headers. make sure it is comprehensive and complete and you dont lose out important information.  Then end off with the summary of the summary and a what should I do",
