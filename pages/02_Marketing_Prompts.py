...
prompt_options = {
    "Summarize": "Extract the key insights and takeaways. Write in point form and organize section in headers. make sure it is comprehensive and complete and you don’t lose out important information. At the end, have a call to action on the next steps based on what the write up suggest. Focus on the main content and ignore other extra text as this is hastily scraped from a website so it contains other content",
